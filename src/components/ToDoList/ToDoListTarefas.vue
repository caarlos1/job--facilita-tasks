    ...
    >
      <div class="tarefa__bloco">
        ...
        <div class="tarefa__importancia">
          <span
            class="tarefa__tags"
            :class="tagPorTipo(tarefa.importancia.tipo)"
          >
...
import { definirListaPorTipo, definirTagPorTipo } from "./ToDoListUtil";
...
export default {
  methods: {
    ...
    tagPorTipo: (tipo) => definirTagPorTipo(tipo),
  },
  ...
  computed: {
    ...
    listaPorTipo() {
      ...
      return definirListaPorTipo(tipo, this);
    },
